...
Source0  : https://files.pythonhosted.org/packages/87/41/07fa466e0525635243f0cb94f81b9e99508edc23af7d9bf6c2009e11eadc/inflection-0.5.0.tar.gz
...
%prep
%setup -q -n inflection-0.5.0
cd %{_builddir}/inflection-0.5.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1591627116
...
cp %{_builddir}/inflection-0.5.0/LICENSE %{buildroot}/usr/share/package-licenses/inflection/3528822a9ec44b4f2c14130be19edc108f3b9423
